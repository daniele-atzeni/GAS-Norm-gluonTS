...
class TransformerTrainingNetwork(TransformerNetwork):
    def hybrid_forward(
        ...
        # save the all the params to a file for testing purposes
        # save it as a pickle file, it should be as a dictionary appending to a list of dictionaries in the pickle file
        import pickle
        params = {
        ...
        # create the pickle file if it does not exist, else, append to it
        try:
