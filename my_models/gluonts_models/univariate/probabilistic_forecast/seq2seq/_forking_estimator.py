...
class ForkingSeq2SeqEstimator(GluonEstimator):
    ...
    def __init__(
        ...
        self.context_length = (
            ...
            else 2 * self.prediction_length  ############### it was 4 *
        )
    ...
    def create_transformation(self) -> Transformation:
        ...
        if self.use_feat_dynamic_real:
            ...
            chain.append(RenameFields({"dynamic_feat": FieldName.FEAT_DYNAMIC_REAL}))
        ...
        if len(dynamic_feat_fields) > 1:
            ...
            chain.append(RenameFields({dynamic_feat_fields[0]: FieldName.FEAT_DYNAMIC}))
    ...
    def create_training_data_loader(
        ...
        **kwargs,
        ...
        input_names = get_hybrid_forward_input_names(ForkingSeq2SeqTrainingNetwork)
