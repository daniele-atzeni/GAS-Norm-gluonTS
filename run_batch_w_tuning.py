...
from my_models.gluonts_models.batch_norm.simple_feedforward import SimpleFeedForwardEstimator
...
from my_models.gluonts_models.batch_norm.transformer import TransformerEstimator
...
class Objective:
    ...
    def train_and_test(self, params, save=False):
      ...
      dir_name = f'TESTTTTT_saved_nonorm_{self.model}_{self.dataset_name}_{self.standardize}'
